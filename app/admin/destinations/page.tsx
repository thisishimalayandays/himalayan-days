        ...
        <div className="max-w-6xl mx-auto">
            <div className="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p className="text-gray-500 text-sm">Manage travel destinations</p>
                </div>
                <Link
                                    ...
                                    <tr key={dest.id} className="hover:bg-gray-50 transition">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div className="flex items-center gap-3">
                                                <Link href={`/admin/destinations/${dest.id}`} className="text-blue-600 hover:text-blue-900 flex items-center gap-1">
